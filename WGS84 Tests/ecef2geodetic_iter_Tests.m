...
@interface ecef2geodetic_iter_Tests : XCTestCase

@end

@implementation ecef2geodetic_iter_Tests
...
- (void)test_ecef2geodetic_Equator_GreenwichMeridian {
    ...
    count = wgs84_ecef2geodetic_iter(wgs84_a + 123.0, 0.0, 0.0, &latitude, &longitude, &height);
...
- (void)test_ecef2geodetic_NorthPole {
    ...
    count = wgs84_ecef2geodetic_iter(0.0, 0.0, wgs84_b + 123.0, &latitude, &longitude, &height);
...
- (void)test_ecef2geodetic_SydneyAustralia {
    ...
    count = wgs84_ecef2geodetic_iter(-4646012.8, 2553292.4, -3534517.0, &latitude, &longitude, &height);
...
- (void)test_ecef2geodetic_SomewhereSomeplace {
    ...
    count = wgs84_ecef2geodetic_iter(-2262330.973, 3918472.189, 4494419.477, &latitude, &longitude, &height);
...
- (void)test_ecef2geodetic_SomewhereElsewhere {
    ...
    count = wgs84_ecef2geodetic_iter(4210520.621, 1128205.600, 4643227.496, &latitude, &longitude, &height);
